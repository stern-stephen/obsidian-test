...
<!-- semantic-edges
{"source":"Virtual Work and D'Alembert's Principle","relation":"PART_OF","target":"Mechanics","evidence_heading":"Overview","evidence_summary":"This concept note belongs to the Mechanics area of the vault.","confidence":0.85}
{"source":"Virtual Work and D'Alembert's Principle","relation":"MECHANICS_RELATED_TO","target":"Constraints","evidence_heading":"Related Concepts","evidence_summary":"The note explicitly connects Virtual Work and D'Alembert's Principle with Constraints in its discussion or related-note links.","confidence":0.75}
{"source":"Virtual Work and D'Alembert's Principle","relation":"MECHANICS_RELATED_TO","target":"Generalized Coordinates","evidence_heading":"Related Concepts","evidence_summary":"The note explicitly connects Virtual Work and D'Alembert's Principle with Generalized Coordinates in its discussion or related-note links.","confidence":0.75}
{"source":"Virtual Work and D'Alembert's Principle","relation":"MECHANICS_RELATED_TO","target":"Inertial Forces","evidence_heading":"Related Concepts","evidence_summary":"The note explicitly connects Virtual Work and D'Alembert's Principle with Inertial Forces in its discussion or related-note links.","confidence":0.75}
{"source":"Virtual Work and D'Alembert's Principle","relation":"MECHANICS_RELATED_TO","target":"Lagrangian Mechanics","evidence_heading":"Related Concepts","evidence_summary":"The note explicitly connects Virtual Work and D'Alembert's Principle with Lagrangian Mechanics in its discussion or related-note links.","confidence":0.75}
-->
