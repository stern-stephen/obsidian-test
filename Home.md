...
Welcome to a tiny Obsidian vault for working with Codex.
...
- Ask Codex to create, update, summarize, or reorganize notes.
- Use Markdown links to connect ideas across notes.
- Keep rough notes in [Inbox](Inbox.md), then ask Codex to turn them into structured notes.
- Track decisions and next actions in [Tasks](Tasks.md).
