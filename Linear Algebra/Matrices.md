...
This is why matrices are central to [Linear Algebra](Linear%20Algebra.md), [Change of Basis](Change%20of%20Basis.md), [Gaussian Elimination](Gaussian%20Elimination.md), [Projection Operators](Projection%20Matrices.md), [Rotation Operators](Rotation%20Matrices.md), [Eigenvalues and Eigenvectors](Eigenvalues%20and%20Eigenvectors.md), [Unitary Operators](Unitary%20Matrices.md), and [Hermitian Operators](Hermitian%20Matrices%20and%20Operators.md): they are concrete coordinate representations of operators.
...
<!-- semantic-edges
{"source":"Matrices","relation":"PART_OF","target":"Linear Algebra","evidence_heading":"Overview","evidence_summary":"This concept note belongs to the Linear Algebra area of the vault.","confidence":0.85}
{"source":"Matrices","relation":"LINEAR_ALGEBRA_RELATED_TO","target":"Change of Basis","evidence_heading":"Operators And Matrix Representations","evidence_summary":"The note explicitly connects Matrices with Change of Basis in its discussion or related-note links.","confidence":0.75}
{"source":"Matrices","relation":"LINEAR_ALGEBRA_RELATED_TO","target":"Linear Algebra","evidence_heading":"Operators And Matrix Representations","evidence_summary":"The note explicitly connects Matrices with Linear Algebra in its discussion or related-note links.","confidence":0.75}
{"source":"Matrices","relation":"LINEAR_ALGEBRA_RELATED_TO","target":"Gaussian Elimination","evidence_heading":"Operators And Matrix Representations","evidence_summary":"The note explicitly connects Matrices with Gaussian Elimination in its discussion or related-note links.","confidence":0.75}
{"source":"Matrices","relation":"LINEAR_ALGEBRA_RELATED_TO","target":"Projection Operators","evidence_heading":"Operators And Matrix Representations","evidence_summary":"The note explicitly connects Matrices with Projection Operators in its discussion or related-note links.","confidence":0.75}
-->
