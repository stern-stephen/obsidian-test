...
This is the reading hub for *Classical Mechanics* (3rd ed.) by Herbert Goldstein, Charles Poole, and John Safko.

PDF reference: [Classical Mechanics](../../References/GoldsteinPooleSafkoClassicalMechanics.pdf)
...
- Chapter 1
  ...
  - [Mechanics of a Particle](Chapter%201/Mechanics%20of%20a%20Particle.md)
  - [Mechanics of a System of Particles](Chapter%201/Mechanics%20of%20a%20System%20of%20Particles.md)
  - [Constraints](Chapter%201/Constraints.md)
...
- Which results require only Newton's laws, and which additionally require assumptions about internal forces?
- How do generalized coordinates absorb holonomic constraints?
- Why does virtual work eliminate ideal constraint forces?
- When can velocity-dependent or dissipative forces still be handled in a Lagrangian framework?
- What information is lost when constraint forces are eliminated from the equations of motion?
