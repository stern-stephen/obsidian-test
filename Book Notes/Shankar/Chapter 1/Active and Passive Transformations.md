...
<!-- semantic-edges
{"source":"Active Transformations","relation":"CONTRASTS_WITH","target":"Passive Transformations","evidence_heading":"Big Ideas","evidence_summary":"Contrasts transformations that change the vector with transformations that change the basis used to describe the vector.","confidence":0.9}
{"source":"Passive Transformations","relation":"REFORMULATES","target":"Change of Basis","evidence_heading":"Notes","evidence_summary":"Interprets a basis change as keeping the abstract vector fixed while changing its component description.","confidence":0.9}
{"source":"Unitary Transformations","relation":"ENABLES","target":"Change of Representation","evidence_heading":"Big Ideas","evidence_summary":"Explains that unitary transformations can describe changed states, changed bases, or changed representations depending on what is held fixed.","confidence":0.88}
{"source":"Similarity Transformations","relation":"DETERMINES","target":"Trace Invariance","evidence_heading":"Exercise Answers","evidence_summary":"Uses cyclicity of trace to show that a unitary similarity transformation leaves trace unchanged.","confidence":0.86}
-->
